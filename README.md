...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-30jnhwo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-30jnhwo.containers.anotherwebservice.com/
...
```
git clone git@github.com:QuizzityMC/container-30jnhwo.git
cd container-30jnhwo
```
...
```
docker attach container-30jnhwo
```
